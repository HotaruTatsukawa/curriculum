...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        // その理由をコメントへ記述してください。
        /* [ここへ記述]Calendar.MONTHは実値が0〜11の定義のため、
        1月以上の繰り上げや繰り下げをした場合数値が13や14や15という表示になってしまうため*/
        ...
        int d1 = calendar.get(Calendar.YEAR);
        int d2 = calendar.get(Calendar.MONTH)+1;
        int d3 = calendar.get(Calendar.DATE);
